...
export default function RecipesPage() {
  ...
  const itemsByDate = unusedItems.sort((itemA, itemB) => new Date(itemA.expirationDate) - new Date(itemB.expirationDate))
  ...
  return (
    <div>
      <h2>{ingredient} expiring soon. Here are 10 suggested recipes using {ingredient}:</h2>
